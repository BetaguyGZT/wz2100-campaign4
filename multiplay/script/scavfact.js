...
function eventGameInit()
{
	...
	makeComponentAvailable("BaBaWheel", me);
	makeComponentAvailable("BaBaHTrack", me);
	makeComponentAvailable("BaBaTrack", me);
	makeComponentAvailable("BaBaVtol", me);
	...
	completeResearch("R-NEXUS-Immunity",me); //Makes the Scavengers immune to NEXUS absorption.
...
function eventDroidBuilt(droid, fac1)
{
	...
	if (fac1 && structureIdle(fac1) && groupSize(attackGroup) < maxDroids)
	{
		...
		case 3: buildDroid(fac1, "Cannonbus", "BusBody", "BaBaWheel", "", DROID_WEAPON, "BusCannon"); break;
		case 4: buildDroid(fac1, "Firebus", "BusBody", "BaBaWheel", "", DROID_WEAPON, "BabaFlame"); break;
